...
namespace Iqui_WareHouse.ViewModels
{
    ...
    public class SettingsViewModel : ObservableObject, INavigationAware
    {
        ...
        private ICommand _iquiWebCommand;
        ...
        public ICommand IquiWebCommand => _iquiWebCommand ?? (_iquiWebCommand = new RelayCommand(OnIquiWeb));
        ...
        private void OnIquiWeb()
            => _systemService.OpenInWebBrowser(_appConfig.IquiWeb);
    }
}
